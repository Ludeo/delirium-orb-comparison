...
//    using oil;
//
//    var oil = Oil.FromJson(jsonString);
...
namespace oil
{
    ...
    public partial class Oil
    {
        public static Oil FromJson(string json) => JsonConvert.DeserializeObject<Oil>(json, oil.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Oil self) => JsonConvert.SerializeObject(self, oil.Converter.Settings);
    }
