...
namespace Delirium.oil
{
    ...
    public class Sparkline
    {
        ...
        public long TotalChange { get; set; }
    }

    public partial class Oil
    {
        public static Oil FromJson(string json) => JsonConvert.DeserializeObject<Oil>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Oil self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
