...
//    using scarab;
//
//    var scarab = Scarab.FromJson(jsonString);
...
namespace scarab
{
    ...
    public partial class Scarab
    {
        public static Scarab FromJson(string json) => JsonConvert.DeserializeObject<Scarab>(json, scarab.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Scarab self) => JsonConvert.SerializeObject(self, scarab.Converter.Settings);
    }
