...
namespace Delirium.scarab
{
    ...
    public partial class Scarab
    {
        public static Scarab FromJson(string json) => JsonConvert.DeserializeObject<Scarab>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Scarab self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
