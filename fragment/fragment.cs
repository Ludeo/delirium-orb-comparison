...
namespace Delirium.fragment
{
    ...
    public partial class Fragment
    {
        public static Fragment FromJson(string json) => JsonConvert.DeserializeObject<Fragment>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Fragment self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
