...
//    using fossil;
//
//    var fossil = Fossil.FromJson(jsonString);
...
namespace fossil
{
    ...
    public partial class Fossil
    {
        public static Fossil FromJson(string json) => JsonConvert.DeserializeObject<Fossil>(json, fossil.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Fossil self) => JsonConvert.SerializeObject(self, fossil.Converter.Settings);
    }
