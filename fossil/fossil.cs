...
namespace Delirium.fossil
{
    ...
    public partial class Fossil
    {
        public static Fossil FromJson(string json) => JsonConvert.DeserializeObject<Fossil>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Fossil self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
