...
namespace Delirium.essence
{
    ...
    public partial class Essence
    {
        public static Essence FromJson(string json) => JsonConvert.DeserializeObject<Essence>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Essence self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
