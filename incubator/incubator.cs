...
//    using incubator;
//
//    var incubator = Incubator.FromJson(jsonString);
...
namespace incubator
{
    ...
    public partial class Incubator
    {
        public static Incubator FromJson(string json) => JsonConvert.DeserializeObject<Incubator>(json, incubator.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Incubator self) => JsonConvert.SerializeObject(self, incubator.Converter.Settings);
    }
